...
onSubmit=(e)=>{
  ...
  console.log(this.state);
    axios.post('http://localhost:8080/backend-mall-management/AdminPage/MallEmployee/Employee.php',this.state)
...
onDelete=(e)=>{
  ...
  axios.get('http://localhost:8080/backend-mall-management/AdminPage/MallEmployee/DeleteEmployee.php?Employee1='+Employee1)
...
onUpdate=(e)=>{
 ...
 var Employee_Id=document.getElementById('Employee_Id');
  var Jform=
    ...
    axios.post('http://localhost:8080/backend-mall-management/AdminPage/MallEmployee/UpdateEmployee.php',Jform)
    .then(res => console.log(res.data));
...
componentDidUpdate(){
let myArray=[];
  axios.get('http://localhost:8080/backend-mall-management/AdminPage/MallEmployee/EmployeeList.php')
  .then(response=>{
